MODEL_PRICING: dict[str, dict[str, float]] = {
    # Prefixed keys (provider/model) — used by existing analytics & comparisons
    ...
    # Plain-name keys — match raw model strings returned by OpenAI/Anthropic SDKs
...
HIGH_COST_MODELS = {"claude-3-opus", "claude-3-opus-20240229", "anthropic/claude-3-opus",
