...
class QualityEvaluation(Base):
    ...
    span_name: Mapped[str] = mapped_column(String, nullable=False, default="")
    rec_type: Mapped[str] = mapped_column(String, nullable=False, default="")
    evaluated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)


class EvalCluster(Base):
    """Per-agent eval clusters for Stage 5 rubric-anchored judging."""

    __tablename__ = "eval_clusters"
    ...
    auto_draft_criteria: Mapped[str | None] = mapped_column(Text, nullable=True)
    good_answer_criteria: Mapped[str | None] = mapped_column(Text, nullable=True)
    skip_criteria: Mapped[bool] = mapped_column(Boolean, default=False)
